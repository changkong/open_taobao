...
type SimbaCampaignAreaoptionsGetResponse struct {
	AreaOptions *AreaOptionListObject `json:"area_options"`
}
...
type SimbaCampaignChanneloptionsGetResponse struct {
	ChannelOptions *ChannelOptionListObject `json:"channel_options"`
}
...
type SimbaCampaignsGetResponse struct {
	Campaigns *CampaignListObject `json:"campaigns"`
}
...
type SimbaCreativesGetResponse struct {
	Creatives *CreativeListObject `json:"creatives"`
}
...
type SimbaCreativesRecordGetResponse struct {
	Creativerecords *CreativeRecordListObject `json:"creativerecords"`
}
...
type SimbaInsightCatsGetResponse struct {
	InCategoryTops *INCategoryTopListObject `json:"in_category_tops"`
}
...
type SimbaInsightCatsanalysisGetResponse struct {
	InCategoryAnalyses *INCategoryAnalysisListObject `json:"in_category_analyses"`
}
...
type SimbaInsightCatsbaseGetResponse struct {
	InCategoryBases *INCategoryBaseListObject `json:"in_category_bases"`
}
...
type SimbaInsightWordsanalysisGetResponse struct {
	InWordAnalyses *INWordAnalysisListObject `json:"in_word_analyses"`
}
...
type SimbaInsightWordscatsGetResponse struct {
	InWordCategories *INWordCategoryListObject `json:"in_word_categories"`
}
...
type SimbaNonsearchAdgroupplacesAddResponse struct {
	AdgroupPlaceList *ADGroupPlaceListObject `json:"adgroup_place_list"`
}
...
type SimbaNonsearchAlldemographicsGetResponse struct {
	DemographicList *DemographicListObject `json:"demographic_list"`
}
...
type SimbaNonsearchAllplacesGetResponse struct {
	PlaceList *PlaceListObject `json:"place_list"`
}
...
type SimbaNonsearchDemographicsGetResponse struct {
	DemographicSettingList *DemographicSettingListObject `json:"demographic_setting_list"`
}
...
type SimbaToolsItemsTopGetResponse struct {
	Rankeditems *RankedItemListObject `json:"rankeditems"`
}
